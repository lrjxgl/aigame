...
class text2text{
	...
	public static $model="";
	public static $baseurl="https://api.lkeap.cloud.tencent.com/v1";
	public static function init($cfg=[]){
		$arr=explode(",",$cfg["tencent_api_key"]);
		shuffle($arr);
		$api_key=$arr[0];
        self::$api_key= $api_key;
		if(!empty($cfg["tencent_text2text_model"])){
			self::$model=$cfg["tencent_text2text_model"];
		}else{
